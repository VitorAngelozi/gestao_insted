...
class Curso(models.Model):
    ...
    semestre_periodo = models.ForeignKey(SemestrePeriodo, on_delete=models.CASCADE, related_name='cursos', null=True, blank=True)
...
class Sala(models.Model):
    ...
    andar = models.ForeignKey(Andar, on_delete=models.CASCADE, related_name='salas', null=True, blank=True)
